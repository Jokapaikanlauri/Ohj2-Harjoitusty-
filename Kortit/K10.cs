...
{
    public partial class Kymmenen : Form
    {
        ...
        public Kymmenen (Aloitus A)
        {
            ...
            Korttilista.Add(pb10_1);
            Korttilista.Add(pb10_2);
            Korttilista.Add(pb10_3);
            Korttilista.Add(pb10_4);
            Korttilista.Add(pb10_5);
            Korttilista.Add(pb10_6);
            Korttilista.Add(pb10_7);
            Korttilista.Add(pb10_8);
            Korttilista.Add(pb10_9);
            Korttilista.Add(pb10_10);
        ...
        public int[] arvotut = new int[10]; //katsotaan tätä kautta onko samaa numeroa jo arvottu
        ...
        private void Arpominen()
        {
            ...
            if (vaikeustaso == "helppo")
            {
                ...
                pb10_1.Image = imageList1.Images[arvotut[0]];
                pb10_2.Image = imageList1.Images[arvotut[1]];
                pb10_3.Image = imageList1.Images[arvotut[2]];
                pb10_4.Image = imageList1.Images[arvotut[3]];
                pb10_5.Image = imageList1.Images[arvotut[4]];
                pb10_6.Image = imageList1.Images[arvotut[5]];
                pb10_7.Image = imageList1.Images[arvotut[6]];
                pb10_8.Image = imageList1.Images[arvotut[7]];
                pb10_9.Image = imageList1.Images[arvotut[8]];
                pb10_10.Image = imageList1.Images[arvotut[9]];
            }
        ...
        private void pb10_Click_1(object sender, EventArgs e)
        {
        ...
        {
            pb10_1.Image = Properties.Resources.pelikortti;
            pb10_2.Image = Properties.Resources.pelikortti;
            pb10_3.Image = Properties.Resources.pelikortti;
            pb10_4.Image = Properties.Resources.pelikortti;
            pb10_5.Image = Properties.Resources.pelikortti;
            pb10_6.Image = Properties.Resources.pelikortti;
            pb10_7.Image = Properties.Resources.pelikortti;
            pb10_8.Image = Properties.Resources.pelikortti;
            pb10_9.Image = Properties.Resources.pelikortti;
            pb10_10.Image = Properties.Resources.pelikortti;
        ...
        private void Kymmenen_FormClosed(object sender, FormClosedEventArgs e)
        {
            A.btnAloita.Enabled = true;
        }
    }
